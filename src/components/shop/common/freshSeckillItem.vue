<template>
  <div class="swiperItem">
    ...
    <swiper loop auto  height="7.5rem" :show-dots="true" dots-position="center">
      <swiper-item><img style="width:100%;height: 100%;" src="../img/ban1.png"></swiper-item>
      <swiper-item><img style="width:100%;height: 100%;" src="../img/ban1.png"></swiper-item>
      <swiper-item><img style="width:100%;height: 100%;" src="../img/ban1.png"></swiper-item>
    </swiper>
    <!--信息-->
    ...
    <div class="wire2"></div>
    <!--底部-->
    <footerfresh-one></footerfresh-one>
  </div>
</template>
<script>
  ...
  import footerfreshOne from '@/components/shop/common/footerfreshOne'
  ...
  export default {
    ...
    components:{Swiper,SwiperItem,shopIofo,lowEvaluation,shopStore,footerfreshOne,guiGe},
  }
