  ...
  <div class="shopIndex">
    ...
    <div class="tab-box">
      ...
      <div class="tab-contents">
        ...
        <div class="tab-content">
          <store-picture v-for="(item,index) in 2" :key="index"></store-picture>
        </div>
        <div class="tab-content">
...
<script>
  ...
  import detailSwiperItem from '@/components/shop/common/detailSwiperItem'
  ...
  export default {
    ...
    components:{detailSwiperItem,storePicture,evaluationDisplay},
    mounted(){
      var that = this;
      setTimeout(function () {
...
<style scoped>
  .shopIndex{background-color: #fff;height: 100%;}
