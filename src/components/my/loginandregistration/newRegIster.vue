<template>
  <div class='register'>
    ...
    <div class="biao">
      ...
      <!--按钮-->
      <div class="btn" v-if="phone!='' && pasw!='' && yzm!='' && radioState == true" @click="regBtn">注册</div>
...
//        }else
        if(isPasswordLen(this.pasw)===false){
          ...
          var that = this;
          submitRegister({phone:this.phone,code:this.yzm,password:pasw,terminalType:'wap'}).then(res => {
            console.log("获取通联注册结果", res);
            if (res.message == "success") {
