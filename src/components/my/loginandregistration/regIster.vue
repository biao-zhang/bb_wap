<template>
  <div class='register'>
    ...
    <div class="biao">
      ...
      <!--按钮-->
      <div class="btn" v-if="nickname!='' && phone!='' && pasw!='' && yzm!='' && radioState == true" @click="regBtn">注册</div>
      <div class="btn disabled" v-else>注册</div>
...
//      发送验证码接口
      ...
      regBtn(){
        ...
        if(this.authcode == false ||this.yzm != this.yzmdata){
          ...
          var that = this;
          this.axios.post('/personally/userRegister/addUser',this.qs.stringify({
            ...
            .then(function (response) {
              ...
              if(datas.message == 'success'){
//                console.log(datas)
//                that.$store.state.toastText='注册成功，请登录'
//                that.$store.state.toastType='success'
//                setTimeout(function () {
