    ...
    methods:{
      ...
      nextStep(){
        if(this.yzm != this.getYzm){
          ...
          this.$router.push({path: '/x/changePwd',query:{isChange:2}})
        }
...
<style scoped>
  ...
  .line .s1{width:20%;color:#333333;font-size:0.3rem;}
  .line input{width:50%;color:#333333;font-size:0.3rem;}
  .line .s2{width:30%;padding-left:0.1rem;color:#f86e0e;font-size:0.3rem;}
